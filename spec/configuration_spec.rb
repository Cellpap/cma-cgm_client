...
describe CMACGMClient::Configuration do
  let(:config) { CMACGMClient::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://apis.cma-cgm.net/operation/trackandtrace/v1")
    # CMACGMClient.configure do |c|
    #   c.host = uri.host
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      # expect(config.base_url).to eq("https://apis.cma-cgm.net/operation/trackandtrace/v1")
    end
