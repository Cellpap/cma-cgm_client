...
# Unit tests for CMACGMClient::ShipmentEventTypeCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::ShipmentEventTypeCode do
  let(:instance) { CMACGMClient::ShipmentEventTypeCode.new }

  describe 'test an instance of ShipmentEventTypeCode' do
    it 'should create an instance of ShipmentEventTypeCode' do
      expect(instance).to be_instance_of(CMACGMClient::ShipmentEventTypeCode)
    end
  end
end
