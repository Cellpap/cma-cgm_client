...
# Unit tests for CMACGMClient::DocumentTypeCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::DocumentTypeCode do
  let(:instance) { CMACGMClient::DocumentTypeCode.new }

  describe 'test an instance of DocumentTypeCode' do
    it 'should create an instance of DocumentTypeCode' do
      expect(instance).to be_instance_of(CMACGMClient::DocumentTypeCode)
    end
  end
end
