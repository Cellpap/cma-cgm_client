...
# Unit tests for CMACGMClient::Seals
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::Seals do
  let(:instance) { CMACGMClient::Seals.new }

  describe 'test an instance of Seals' do
    it 'should create an instance of Seals' do
      expect(instance).to be_instance_of(CMACGMClient::Seals)
    end
  end
