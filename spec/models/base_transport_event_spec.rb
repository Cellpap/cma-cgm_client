...
# Unit tests for CMACGMClient::BaseTransportEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::BaseTransportEvent do
  let(:instance) { CMACGMClient::BaseTransportEvent.new }

  describe 'test an instance of BaseTransportEvent' do
    it 'should create an instance of BaseTransportEvent' do
      expect(instance).to be_instance_of(CMACGMClient::BaseTransportEvent)
    end
  end
