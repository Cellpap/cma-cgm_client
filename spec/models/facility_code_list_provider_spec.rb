...
# Unit tests for CMACGMClient::FacilityCodeListProvider
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::FacilityCodeListProvider do
  let(:instance) { CMACGMClient::FacilityCodeListProvider.new }

  describe 'test an instance of FacilityCodeListProvider' do
    it 'should create an instance of FacilityCodeListProvider' do
      expect(instance).to be_instance_of(CMACGMClient::FacilityCodeListProvider)
    end
  end
end
