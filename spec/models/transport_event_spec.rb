...
# Unit tests for CMACGMClient::TransportEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::TransportEvent do
  let(:instance) { CMACGMClient::TransportEvent.new }

  describe 'test an instance of TransportEvent' do
    it 'should create an instance of TransportEvent' do
      expect(instance).to be_instance_of(CMACGMClient::TransportEvent)
    end
  end
