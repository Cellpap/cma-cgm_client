...
# Unit tests for CMACGMClient::ShipmentEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::ShipmentEvent do
  let(:instance) { CMACGMClient::ShipmentEvent.new }

  describe 'test an instance of ShipmentEvent' do
    it 'should create an instance of ShipmentEvent' do
      expect(instance).to be_instance_of(CMACGMClient::ShipmentEvent)
    end
  end
