...
# Unit tests for CMACGMClient::SubErrorsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::SubErrorsInner do
  let(:instance) { CMACGMClient::SubErrorsInner.new }

  describe 'test an instance of SubErrorsInner' do
    it 'should create an instance of SubErrorsInner' do
      expect(instance).to be_instance_of(CMACGMClient::SubErrorsInner)
    end
  end
