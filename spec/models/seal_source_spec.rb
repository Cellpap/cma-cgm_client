...
# Unit tests for CMACGMClient::SealSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::SealSource do
  let(:instance) { CMACGMClient::SealSource.new }

  describe 'test an instance of SealSource' do
    it 'should create an instance of SealSource' do
      expect(instance).to be_instance_of(CMACGMClient::SealSource)
    end
  end
end
