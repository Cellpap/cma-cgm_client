...
# Unit tests for CMACGMClient::BaseEquipmentEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::BaseEquipmentEvent do
  let(:instance) { CMACGMClient::BaseEquipmentEvent.new }

  describe 'test an instance of BaseEquipmentEvent' do
    it 'should create an instance of BaseEquipmentEvent' do
      expect(instance).to be_instance_of(CMACGMClient::BaseEquipmentEvent)
    end
  end
  ...
  describe 'test attribute "event_classifier_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PLN", "ACT", "EST"])
      # validator.allowable_values.each do |value|
