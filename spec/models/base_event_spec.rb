...
# Unit tests for CMACGMClient::BaseEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::BaseEvent do
  let(:instance) { CMACGMClient::BaseEvent.new }

  describe 'test an instance of BaseEvent' do
    it 'should create an instance of BaseEvent' do
      expect(instance).to be_instance_of(CMACGMClient::BaseEvent)
    end
  end
