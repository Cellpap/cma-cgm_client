...
# Unit tests for CMACGMClient::SealType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::SealType do
  let(:instance) { CMACGMClient::SealType.new }

  describe 'test an instance of SealType' do
    it 'should create an instance of SealType' do
      expect(instance).to be_instance_of(CMACGMClient::SealType)
    end
  end
end
