...
# Unit tests for CMACGMClient::BaseShipmentEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::BaseShipmentEvent do
  let(:instance) { CMACGMClient::BaseShipmentEvent.new }

  describe 'test an instance of BaseShipmentEvent' do
    it 'should create an instance of BaseShipmentEvent' do
      expect(instance).to be_instance_of(CMACGMClient::BaseShipmentEvent)
    end
  end
