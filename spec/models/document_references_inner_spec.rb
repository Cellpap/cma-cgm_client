...
# Unit tests for CMACGMClient::DocumentReferencesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::DocumentReferencesInner do
  let(:instance) { CMACGMClient::DocumentReferencesInner.new }

  describe 'test an instance of DocumentReferencesInner' do
    it 'should create an instance of DocumentReferencesInner' do
      expect(instance).to be_instance_of(CMACGMClient::DocumentReferencesInner)
    end
  end
  describe 'test attribute "document_reference_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BKG (Booking)", "TRD (Transport Document)"])
