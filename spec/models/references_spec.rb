...
# Unit tests for CMACGMClient::References
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::References do
  let(:instance) { CMACGMClient::References.new }

  describe 'test an instance of References' do
    it 'should create an instance of References' do
      expect(instance).to be_instance_of(CMACGMClient::References)
    end
  end
