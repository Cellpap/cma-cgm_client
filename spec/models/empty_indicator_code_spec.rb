...
# Unit tests for CMACGMClient::EmptyIndicatorCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::EmptyIndicatorCode do
  let(:instance) { CMACGMClient::EmptyIndicatorCode.new }

  describe 'test an instance of EmptyIndicatorCode' do
    it 'should create an instance of EmptyIndicatorCode' do
      expect(instance).to be_instance_of(CMACGMClient::EmptyIndicatorCode)
    end
  end
end
