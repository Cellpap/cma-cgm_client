...
# Unit tests for CMACGMClient::OperationsTransportEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::OperationsTransportEvent do
  let(:instance) { CMACGMClient::OperationsTransportEvent.new }

  describe 'test an instance of OperationsTransportEvent' do
    it 'should create an instance of OperationsTransportEvent' do
      expect(instance).to be_instance_of(CMACGMClient::OperationsTransportEvent)
    end
  end
  ...
  describe 'test attribute "event_classifier_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ACT", "PLN", "EST"])
      # validator.allowable_values.each do |value|
      #   expect { instance.event_classifier_code = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "carrier_specific_data"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
