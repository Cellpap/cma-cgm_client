...
# Unit tests for CMACGMClient::Location
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::Location do
  let(:instance) { CMACGMClient::Location.new }

  describe 'test an instance of Location' do
    it 'should create an instance of Location' do
      expect(instance).to be_instance_of(CMACGMClient::Location)
    end
  end
