...
# Unit tests for CMACGMClient::TransportCallAllOfLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::TransportCallAllOfLocation do
  let(:instance) { CMACGMClient::TransportCallAllOfLocation.new }

  describe 'test an instance of TransportCallAllOfLocation' do
    it 'should create an instance of TransportCallAllOfLocation' do
      expect(instance).to be_instance_of(CMACGMClient::TransportCallAllOfLocation)
    end
  end
