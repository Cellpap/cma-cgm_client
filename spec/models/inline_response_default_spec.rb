...
# Unit tests for CMACGMClient::InlineResponseDefault
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::InlineResponseDefault do
  let(:instance) { CMACGMClient::InlineResponseDefault.new }

  describe 'test an instance of InlineResponseDefault' do
    it 'should create an instance of InlineResponseDefault' do
      expect(instance).to be_instance_of(CMACGMClient::InlineResponseDefault)
    end
  end
