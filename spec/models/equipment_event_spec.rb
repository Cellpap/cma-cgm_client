...
# Unit tests for CMACGMClient::EquipmentEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::EquipmentEvent do
  let(:instance) { CMACGMClient::EquipmentEvent.new }

  describe 'test an instance of EquipmentEvent' do
    it 'should create an instance of EquipmentEvent' do
      expect(instance).to be_instance_of(CMACGMClient::EquipmentEvent)
    end
  end
