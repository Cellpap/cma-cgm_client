...
# Unit tests for CMACGMClient::EquipmentEventTypeCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::EquipmentEventTypeCode do
  let(:instance) { CMACGMClient::EquipmentEventTypeCode.new }

  describe 'test an instance of EquipmentEventTypeCode' do
    it 'should create an instance of EquipmentEventTypeCode' do
      expect(instance).to be_instance_of(CMACGMClient::EquipmentEventTypeCode)
    end
  end
end
