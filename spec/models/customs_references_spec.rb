...
# Unit tests for CMACGMClient::CustomsReferences
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::CustomsReferences do
  let(:instance) { CMACGMClient::CustomsReferences.new }

  describe 'test an instance of CustomsReferences' do
    it 'should create an instance of CustomsReferences' do
      expect(instance).to be_instance_of(CMACGMClient::CustomsReferences)
    end
  end
  ...
  describe 'test attribute "customs_reference"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
