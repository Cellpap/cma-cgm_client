...
# Unit tests for CMACGMClient::TransportEventTypeCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::TransportEventTypeCode do
  let(:instance) { CMACGMClient::TransportEventTypeCode.new }

  describe 'test an instance of TransportEventTypeCode' do
    it 'should create an instance of TransportEventTypeCode' do
      expect(instance).to be_instance_of(CMACGMClient::TransportEventTypeCode)
    end
  end
end
