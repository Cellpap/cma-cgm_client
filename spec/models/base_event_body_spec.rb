...
# Unit tests for CMACGMClient::BaseEventBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::BaseEventBody do
  let(:instance) { CMACGMClient::BaseEventBody.new }

  describe 'test an instance of BaseEventBody' do
    it 'should create an instance of BaseEventBody' do
      expect(instance).to be_instance_of(CMACGMClient::BaseEventBody)
    end
  end
