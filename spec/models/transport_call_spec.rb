...
# Unit tests for CMACGMClient::TransportCall
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::TransportCall do
  let(:instance) { CMACGMClient::TransportCall.new }

  describe 'test an instance of TransportCall' do
    it 'should create an instance of TransportCall' do
      expect(instance).to be_instance_of(CMACGMClient::TransportCall)
    end
  end
