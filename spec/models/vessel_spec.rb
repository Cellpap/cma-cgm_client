...
# Unit tests for CMACGMClient::Vessel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::Vessel do
  let(:instance) { CMACGMClient::Vessel.new }

  describe 'test an instance of Vessel' do
    it 'should create an instance of Vessel' do
      expect(instance).to be_instance_of(CMACGMClient::Vessel)
    end
  end
