...
# Unit tests for CMACGMClient::ReferenceType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::ReferenceType do
  let(:instance) { CMACGMClient::ReferenceType.new }

  describe 'test an instance of ReferenceType' do
    it 'should create an instance of ReferenceType' do
      expect(instance).to be_instance_of(CMACGMClient::ReferenceType)
    end
  end
end
