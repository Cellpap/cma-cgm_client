...
# Unit tests for CMACGMClient::VesselOperatorCarrierCodeListProvider
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::VesselOperatorCarrierCodeListProvider do
  let(:instance) { CMACGMClient::VesselOperatorCarrierCodeListProvider.new }

  describe 'test an instance of VesselOperatorCarrierCodeListProvider' do
    it 'should create an instance of VesselOperatorCarrierCodeListProvider' do
      expect(instance).to be_instance_of(CMACGMClient::VesselOperatorCarrierCodeListProvider)
    end
  end
end
