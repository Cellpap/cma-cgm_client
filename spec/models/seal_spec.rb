...
# Unit tests for CMACGMClient::Seal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::Seal do
  let(:instance) { CMACGMClient::Seal.new }

  describe 'test an instance of Seal' do
    it 'should create an instance of Seal' do
      expect(instance).to be_instance_of(CMACGMClient::Seal)
    end
  end
  ...
  describe 'test attribute "seal_source"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "seal_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
