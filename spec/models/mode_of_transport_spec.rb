...
# Unit tests for CMACGMClient::ModeOfTransport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::ModeOfTransport do
  let(:instance) { CMACGMClient::ModeOfTransport.new }

  describe 'test an instance of ModeOfTransport' do
    it 'should create an instance of ModeOfTransport' do
      expect(instance).to be_instance_of(CMACGMClient::ModeOfTransport)
    end
  end
end
