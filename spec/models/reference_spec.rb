...
# Unit tests for CMACGMClient::Reference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CMACGMClient::Reference do
  let(:instance) { CMACGMClient::Reference.new }

  describe 'test an instance of Reference' do
    it 'should create an instance of Reference' do
      expect(instance).to be_instance_of(CMACGMClient::Reference)
    end
  end
