...
module CMACGMClient
  class ModeOfTransport
    VESSEL = "VESSEL".freeze
    RAIL = "RAIL".freeze
    TRUCK = "TRUCK".freeze
    BARGE = "BARGE".freeze

    def self.all_vars
      @all_vars ||= [VESSEL, RAIL, TRUCK, BARGE].freeze
    end
    ...
    def build_from_hash(value)
      return value if ModeOfTransport.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ModeOfTransport"
    end
  end
end
