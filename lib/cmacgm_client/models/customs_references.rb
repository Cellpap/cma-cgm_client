...
module CMACGMClient
  class CustomsReferences
    ...
    attr_accessor :customs_reference
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CMACGMClient::CustomsReferences` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CMACGMClient::CustomsReferences`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'customs_reference')
        self.customs_reference = attributes[:'customs_reference']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          customs_reference == o.customs_reference &&
    ...
    def hash
      [equipment_reference, customs_reference, reference_date].hash
    end
