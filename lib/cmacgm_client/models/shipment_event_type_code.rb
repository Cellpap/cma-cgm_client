...
module CMACGMClient
  class ShipmentEventTypeCode
    ...
    def self.all_vars
      @all_vars ||= [RECE, DRFT, PENA, PENU, REJE, APPR, ISSU, SURR, SUBM, VOID, CONF, REQS, CMPL, HOLD, RELS].freeze
    end
    ...
    def build_from_hash(value)
      return value if ShipmentEventTypeCode.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ShipmentEventTypeCode"
    end
  end
end
