...
module CMACGMClient
  class VesselOperatorCarrierCodeListProvider
    SMDG = "SMDG".freeze
    NMFTA = "NMFTA".freeze

    def self.all_vars
      @all_vars ||= [SMDG, NMFTA].freeze
    end
    ...
    def build_from_hash(value)
      return value if VesselOperatorCarrierCodeListProvider.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #VesselOperatorCarrierCodeListProvider"
    end
  end
end
