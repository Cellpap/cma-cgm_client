...
module CMACGMClient
  class FacilityTypeCodeTRN
    ...
    def self.all_vars
      @all_vars ||= [BOCR, CLOC, COFS, COYA, OFFD, DEPO, INTE, POTE, RAMP].freeze
    end
    ...
    def build_from_hash(value)
      return value if FacilityTypeCodeTRN.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #FacilityTypeCodeTRN"
    end
  end
end
