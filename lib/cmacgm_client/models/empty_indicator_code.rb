...
module CMACGMClient
  class EmptyIndicatorCode
    EMPTY = "EMPTY".freeze
    LADEN = "LADEN".freeze

    def self.all_vars
      @all_vars ||= [EMPTY, LADEN].freeze
    end
    ...
    def build_from_hash(value)
      return value if EmptyIndicatorCode.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #EmptyIndicatorCode"
    end
  end
end
