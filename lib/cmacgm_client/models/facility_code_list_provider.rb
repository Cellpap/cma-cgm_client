...
module CMACGMClient
  class FacilityCodeListProvider
    BIC = "BIC".freeze
    SMDG = "SMDG".freeze

    def self.all_vars
      @all_vars ||= [BIC, SMDG].freeze
    end
    ...
    def build_from_hash(value)
      return value if FacilityCodeListProvider.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #FacilityCodeListProvider"
    end
  end
end
